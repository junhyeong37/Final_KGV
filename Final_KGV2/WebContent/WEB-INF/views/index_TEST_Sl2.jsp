...
<link rel="stylesheet" href="assets/slide/slide.css">
</head>
<style>
.video {
	position: relative;
...
<body>
							...
							<div class="card-action" style="">
								...
								<div id="carousel">
									<div class="slideImg hideLeft">
										...
										<br /> <a href="chart.jsp" style="color: black;">예매하기</a>
									</div>
									...
									<div class="slideImg selected">
										...
										<br /> <a href="chart.jsp" style="color: black;">[예매하기]</a> <a
											href="chart.jsp" style="color: black;">영화정보</a>
									</div>
	...
	<script src="assets/slide/slide.js"></script>
