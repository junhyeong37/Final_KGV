<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!-- 위에 3개 다 필요는 없는데 c랑 fmt는 자주 쓰임 참고 -->		
						...
						<div class="card-content" style="text-align: center;">
							<div class="table-responsive">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<thead>
										<tr>
											<th width="30%;" ><p style="cursor: pointer;"><font color="red">개봉일순</font></p></th>
											<th width="60%" style="border-right-color:white;"><p style="cursor: pointer;"><font color="red">가나다순</font></p></th>
											<th width="10%"></th>
										</tr>
									</thead>
									<tbody>
