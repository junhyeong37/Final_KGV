...
<div id="myCarousel" class="carousel slide" data-ride="carousel" style="height: 100%"> 
   ...
   <div class="carousel-inner" style="height: 100%; background-color: #0a0a0a;">
      ...
      <td style="text-align: center;">
         ...
         <div class="video">
                           <iframe width="80%" height="90%"
                              src="assets/img/kim6.jpg"   frameborder="0"> </iframe>
      ...
      <td style="text-align: center;">
         ...
         <!-- <a href="MovieSearchData.do?movie_photo=assets/img/movie0.jpg"> -->
         <img src="assets/img/kim5.jpg" class="img-mobile" style="margin:auto;" data-src="" alt="Second slide">
...
<!-- style="width: 70%; height: 70%;" -->
         ...
         <div id="page-inner" style="padding-left: 0px; padding-right: 0px;">
            <div class="row">
               ...
               <div class="card col-md-10" style="background-image: url('assets/img/backimg1.jpg'); text-align: center; padding-left: 0px; 
               padding-right: 0px; margin-bottom:0px;">
                  ...
                  <div class="col-md-5" style="padding-left: 0px;padding-right: 0px;">
                        ...
                        <div class="card-content" style="padding-left: 0px;padding-right: 0px;">
                           <img class="mobileimg" height="495px" alt="poster" src="assets/img/movie14.jpg">
                        <br><br> <div><input type="button" value="예매하기"></div>
                     ...
                     <!-- <div class="card"> -->
                        ...
                        <div class="card-content" style="padding-top: 0px;">
                           ...
                           <div class="alert alert-success col-md-12 colorksm" style="background-color: #ffffff00; color: black; border-color: #ffffff00;">
                              <table>
                                 <tr>
                                    ...
                                    <%-- <td><strong>${movie.movie_title }</strong></td> --%>
                                 </tr>
                              </table>

                           </div>

                           <div class="alert alert-info col-md-7" style="background-color: #ffffff00; color: black; border-color: #ffffff00;">
                              <table>
                                 <tr>
                                    <td style="font-size: medium;"><strong>영화등급</strong>&nbsp;&nbsp;12세관람가</td>
                                 </tr>
                              </table>

                           </div>
                           <div class="col-md-5"></div>
                           <div class="alert alert-success col-md-5" style="background-color: #ffffff00; color: black; border-color: #ffffff00;">
                              <table>
                                 <tr>
                                    <td style="font-size: medium;"><strong>장르</strong>&nbsp;&nbsp;로맨스</td>
                           ...
                           <div class="alert alert-info col-md-12" style="background-color: #ffffff00; color: black; border-color: #ffffff00;">
                              <table>
                                 <tr>
                                    <td><strong>감독</strong></td>
                                    <td class="right">정지우</td>
                                 </tr>
                              </table>
                           ...
                           <div class="alert alert-success col-md-12" style="background-color: #ffffff00; color: black; border-color: #ffffff00;">
                              <table>
                                 <tr>
                                    <td><strong>배우</strong></td>
                                    <td class="right">김고은,정해인</td>
                                 </tr>
                              </table>
                  ...
                  <div class="col-md-12">
                      <div class="col-md-1"></div>
                  <div class="card col-md-10" style="margin-top: 0px; background-image: url('assets/img/backimg1.jpg');">
                        ...
                        <div class="card-content">
                           ...
                           <div class="alert alert-success col-md-12">
                              <strong>줄거리</strong> <br> 유열의음악앨범 슬프다
                           </div>
