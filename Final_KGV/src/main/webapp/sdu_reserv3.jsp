...
<div class="table-responsive">
						...
						<div class="col-md-4">
							<div class="card">
								<div class="card-content">
									<table class="table table-striped table-bordered table-hover"
										id="date1" style="margin-bottom: 0px; height: 500px;">
										<thead>
											<tr>
					...
					<div class="card col-md-12">
						...
						<div class="col-md-4">
							<div class="card">
								...
								<div class="card-content">
									<form action="sdu_seat.jsp">
										<input type="text" readonly="readonly" id="A" name="A"
											style="color: black;" /><br /> 
										<input type="text"
											readonly="readonly" id="B" name="B" style="color: black;" /> <br />
										<input type="text" readonly="readonly" id="C" name="C"
											style="color: black;" /> <br /> 
										<input type="text"
											readonly="readonly" id="D" name="D" style="color: black;" /> <br />
										<input type="text" readonly="readonly" id="E" name="E"
											style="color: black;" /> <br />
