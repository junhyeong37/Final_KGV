						...
						<div class="container col-md-6" style="padding-left: 0px;">
							<div class="card" style="height: 370px;">
								<div id="seating-plan" style="-seats-per-row: 20;">
									...
									<div class="seat">
										<input type="checkbox" id="seat-1"><label for="seat-1">1</label>
									</div>
									<div class="seat">
										<input type="checkbox" id="seat-2"><label for="seat-2">2</label>
									</div>
									<div class="seat">
										<input type="checkbox" id="seat-3"><label for="seat-3">3</label>
									</div>
									<div class="seat">
										<input type="checkbox" id="seat-4"><label for="seat-4">4</label>
									</div>
									<div class="seat">
										<input type="checkbox" id="seat-5"><label for="seat-5">5</label>
									</div>
									<div class="seat">
										<input type="checkbox" id="seat-6"><label for="seat-6">6</label>
									</div>
									<div class="seat">
										<input type="checkbox" id="seat-7"><label for="seat-7">7</label>
									</div>
									<div class="seat">
										<input type="checkbox" id="seat-8"><label for="seat-8">8</label>
									</div>
									<div class="seat">
										<input type="checkbox" id="seat-9"><label for="seat-9">9</label>
									</div>
									<div class="seat">
