		...
		<nav class="navbar navbar-default top-navbar" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand waves-effect waves-dark"
					href="head_test2.jsp"><i class="large material-icons">track_changes</i>
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a class="active-menu waves-effect waves-dark"
						href="head_test.jsp"><i class="fa fa-dashboard"></i> Dashboard</a>
					</li>
					...
					<div class="col-xs-12">
						<div class="card">
							...
							<div class="card-action" style="">
								<div class="video">
									<iframe style="width: 100%;" src="https://www.youtube.com/embed/WaxgJggEm3Q" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
								</div>
							</div>
						</div>
					</div>
