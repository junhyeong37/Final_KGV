...
<style>
.header{}
.page-wrapper3{margin-left:260px;margin-right:100%;margin-bottom:15%;width:100%;height:100%;background-color:white;}
.container40{margin-left:15%;margin-top:56px;margin-right:100%;margin-bottom:15%; width:600px;min-height:1200px;}
.sidebar{background-color:black; width:100%;height:400px;}
.person{}
.seat{}
