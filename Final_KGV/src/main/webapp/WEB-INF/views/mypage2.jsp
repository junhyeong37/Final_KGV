...
<body>
	...
	<c:forEach items="${plist }" var="val" varStatus="status">
		...
		포스터 :  <img src="${val.movie_photo }" alt="" style="height: 320px"/>	<br /> 
		<a href="Mypage_delete.do?play_day=${val.play_day }&play_seat=${val.play_seat}"><input type="button" value="예매 취소" /></a> <br />
	</c:forEach>
