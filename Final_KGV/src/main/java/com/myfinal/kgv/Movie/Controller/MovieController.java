...
//		movie_name = movie_name.replace("¿µÈ­Á¦¸ñ : ", "");
//		play_theater = play_theater.replace("±ØÀåÀÌ¸§ : ", "");
//		play_day = play_day.replace("³¯Â¥ : ", "");
//		play_inwon = play_inwon.replace("ÀÎ¿ø : ", "");
//		play_seat = play_seat.replace("ÁÂ¼® ","");
//		play_price = play_price.replace("±Ý¾× : ", "");
